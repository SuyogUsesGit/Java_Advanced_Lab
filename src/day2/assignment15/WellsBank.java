...
public class WellsBank {
    public static void main(String[] args) {
        ...
        Account savingAccount = new SavingsAccount(1, customer, 1000, 500, 12);

        Account overdraftAccount = new OverdraftAccount(2, customer, 1000, 2000);
